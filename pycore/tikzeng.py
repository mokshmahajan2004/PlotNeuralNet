...
def to_FullyConnected(name, s_filer, offset, to, width, height, depth, caption):
    return to_ConvSoftMax(name=name, s_filer=s_filer, offset=offset, to=to, width=width, height=height, depth=depth, caption=caption)
