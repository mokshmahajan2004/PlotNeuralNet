...
arch = [
    ...
    # Input Image
    to_input('../examples/fcn8s/drowsy.png', width=10, height=10, name='input'),
    ...
    *block_4ConvPool(name='b5', botton='pool_b4', top='pool_b5', s_filer=14, n_filer=512, offset="(1,0,0)", size=(16,16,5.5), opacity=0.5),
    ...
    to_FullyConnected(name='fc2', s_filer=1, offset="(1,0,0)", to="(fc1-east)", width=1, height=1, depth=20, caption='Dense 256'),
    to_connection('fc1', 'fc2'),
    
    to_FullyConnected(name='fc3', s_filer=1, offset="(1,0,0)", to="(fc2-east)", width=1, height=1, depth=10, caption='Dense Softmax'),
    to_connection('fc2', 'fc3'),
    
    to_SoftMax(name='softmax', s_filer=5, offset="(1,0,0)", to="(fc3-east)", caption='Output'),
